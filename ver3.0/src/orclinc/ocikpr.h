/*
 * $Header: ocikpr.h 21-apr-96.20:57:18 dchatter Exp $ 
 */

/* Copyright (c) 1991, 1995, 1996, 1999 by Oracle Corporation */
/*
   NAME
...
sword  odefin( /*_ struct cda_def *cursor, sword pos, ub1 *buf,
                 ...
                 OraText *fmt, sword fmtl, sword fmtt, ub2 *rlen, ub2 *rcode _*/ );
